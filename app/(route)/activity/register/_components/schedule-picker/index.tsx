  ...
  return (
    <div className="grid gap-2 tablet:gap-[10px]">
      <div className="grid grid-cols-[1fr_79px_128px] gap-[5px] tablet:grid-cols-[1fr_109px_165px] lg:grid-cols-[1fr_158px_216px] lg:gap-5">
        <span className="font-medium leading-[1.6] text-gray-700 tablet:text-xl tablet:leading-[1.3]">날짜</span>
        <span className="font-medium leading-[1.6] text-gray-700 tablet:text-xl tablet:leading-[1.3]">시작 시간</span>
        <span className="font-medium leading-[1.6] text-gray-700 tablet:text-xl tablet:leading-[1.3]">종료 시간</span>
      </div>
