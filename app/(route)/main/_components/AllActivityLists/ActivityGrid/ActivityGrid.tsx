...
export default function ActivityGrid({ activities, isLoading, isError, onClick }: ActivityGridProps) {
  ...
  return (
    <div className="mx-auto mb-[40px] mt-4 grid grid-cols-2 grid-rows-2 gap-x-[8px] gap-y-[20px] mobile:mb-[60px] mobile:mt-7 mobile:grid-cols-3 mobile:grid-rows-3 mobile:gap-x-[16px] mobile:gap-y-[32px] tablet:grid-cols-4 tablet:grid-rows-2 tablet:gap-x-[24px]">
